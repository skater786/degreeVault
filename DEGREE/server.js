...
var sql345='INSERT INTO student2  VALUES ("'+request.body.rollNo+'","'+request.body.univName+'","'+request.body.studName+'","'+request.body.fatherName+'","'+request.body.course+'","'+request.body.dateOfAward+'","'+request.body.grade+'")';
...
con.query(sql,function(err,request)
{
    ...
    {
      return response.render('Error',{
        error:"Wrong data format Correct format is YYYY-MM-DD",
        link:'/login',
        method:'post'
      })
...
con.query(sql345,function(err,request)
{})
